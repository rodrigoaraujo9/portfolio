...
export default function Page() {
    return (
        <div className="relative min-h-screen">
            {/* Light rays container - fixed to cover entire viewport */}

            {/* Main content with relative positioning to stay above light rays */}
                            ...
                            <div className="flex flex-col items-center justify-center space-y-4 text-center">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                        ...
                                        problems to physics simulations and
                                        complex deployable websites. Here are
                                        some of the projects I enjoyed working
                                        on the most!
                                    </p>
                                </div>
                            </div>
